...
namespace Paypal.NET.Controllers
{
    ...
    // The annotation could include a comma separated list or different roles.
    ...
    public class UserRoleController : Controller
    {
        ...
        public async Task<IActionResult> Create(UserRoleVM userRoleVM)
        {
            ...
            {
                var addUR = await userRoleRepo
                    .AddUserRole(userRoleVM.Email, userRoleVM.Role);
            }
